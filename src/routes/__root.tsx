...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      // Safari historically probes additional sizes when only 180 is declared.
      // Declaring 152 (iPad) and 167 (iPad Pro) explicitly stops requests
      // for /apple-touch-icon-152x152.png and similar legacy filenames.
      {
        rel: "apple-touch-icon",
        sizes: "152x152",
        href: appleTouchIconUrl,
      ...
      // Pre-iOS 7 fallback. Without it, old Safari probes
      // /apple-touch-icon-precomposed.png even on modern sites.
      {
